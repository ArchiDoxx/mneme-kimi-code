...
| Server Logs | `~/.kimi-code/mneme/server.log` | `~/.kimi-code/mneme/server.log` | `~/.kimi-code/mneme/server.log` | `~/.kimi-code/mneme/server.log` |
...
- **Logs**: Server stdout/stderr redirected to `~/.kimi-code/mneme/server.log`
